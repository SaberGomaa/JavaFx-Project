 ...
 * @author Ali Tahoon
 */
public class coursesTableviewControllerupdate implements Initializable {
    ...
    TextField txtName;
    @FXML
    private TableView<models.course> tblviewcourses;
    @FXML
    ...
    models.course registeredCourses = null;
    ...
    private void getUpdate(javafx.scene.input.MouseEvent event) {
        try {
            query = "update  courses set coursesname = " + "'" + txtName.getText() + "'"
    ...
    public void getRefresh() {
        try {
            ...
            Logger.getLogger(coursesTableviewControllerupdate.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    @FXML
    public void ready() {
        registeredCourses = tblviewcourses.getSelectionModel().getSelectedItem();
        txtID.setText(String.valueOf(registeredCourses.getId()));
